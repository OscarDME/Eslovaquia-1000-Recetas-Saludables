...
export const copy = {
    ...
    items: [
      {
        ...
        desc: "Obrovská rozmanitosť vyvážených jedál – od parádnych obedov a večerí až po zdravé domáce omáčky a lahodné krémy.",
      },
      {
        icon: "BookOpen",
  ...
  finalCta: {
    ...
    urgencyTop: "ZĽAVA 80%",
    headline:
      "ZÍSKAJ NAŠU DIGITÁLNU KNIHU EŠTE DNES S OBROVSKOU ZĽAVOU!",
    subUrgency:
  ...
  faq: {
    authorRole: "Šéfkuchárka Petra Nováková a Tím pre zdravú výživu",
  ...
  closing: {
    ...
    subheadline:
      "Už dnes môžeš začať jesť chutne a s radosťou, bez toho, aby si zanedbával svoju cukrovku. Zajtra už táto cena naozaj nemusí byť dostupna.",
    regularPrice: "44.50 €",
    offerPrice: "8.90 €",
