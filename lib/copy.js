...
export const copy = {
  metadata: {
    title: "Esencia Pro | 1000 zdravých receptov 2.0",
    description:
  ...
  brand: {
    name: "Esencia Pro",
    tagline: "1000 zdravých receptov 2.0",
  },
    ...
    items: [
      {
        ...
        tag: "BONUS 1",
        title: "E-kniha: 15 zdravých polievok",
        desc: "Obsahuje 15 výborných receptov na teplé polievky s nízkym obsahom sacharidov a cukrov.",
        value: "15 €",
      },
      {
        image: "/bonuses/batidos.webp",
        tag: "BONUS 2",
        title: "E-kniha: 10 zdravých smoothies",
        desc: "10 receptov na osviežujúce smoothies, ktoré sú chudobné na sacharidy a úplne bez pridaného cukru.",
        value: "15 €",
      },
      {
        image: "/bonuses/snacks.webp",
        tag: "BONUS 3",
        title: "E-kniha: 15 zdravých snackov",
        desc: "15 super nápadov na rýchle a zdravé maškrtenie bez výčitiek pre ľudí s cukrovkou.",
        value: "15 €",
      },
      {
  ...
  finalCta: {
    ...
    bundleList: [
      ...
      "Bonus 1 — 15 zdravých polievok",
      "Bonus 2 — 10 zdravých smoothies",
      "Bonus 3 — 15 zdravých snackov",
  ...
  faq: {
    authorRole: "Esencia Pro · Tím pre zdravú výživu",
    authorHeadline: "Chutné jedlo, ktoré sa zároveň stará o tvoje zdravie",
    authorBio:
      "V Esencia Pro sme presvedčení, že cukrovka by ťa nikdy nemala pripraviť o radosť z dobrého jedla. Každý jeden recept sme vytvorili tak, aby si si pochutil bez akýchkoľvek výčitiek a pritom si udržal glukózu pevne pod kontrolou.",
    authorImageAlt: "Tím Esencia Pro",
